({
    ...
    loadData : function(component) {
        ...
        var fSetName = component.get("v.fieldSetName");
        var tFieldSource = component.get("v.typeFieldSource");
        var wClause = component.get("v.whereClause");
        ...
        action.setParams({ fieldSetName : component.get("v.fieldSetName"),typeFieldSource : component.get("v.typeFieldSource"),  whereClause : component.get("v.whereClause"),objectName : component.get("v.objectName"),
                          parentName : component.get("v.parentId"),recordId : component.get("v.recordId"),sObjectType : sObjectType, recordIdOverride : recordIdOverride, sortBy : sortedBy});
    ...
    loadFormaterData : function(component) {
        ...
        for(var i = 0; i < maxItem; i ++) {
            ...
            var currentObject = {editAccess :data[i].editAccess , deleteAccess : data[i].deleteAccess, Id : data[i].Id, hasSubs : data[i].hasSubs};
            currentObject.data = [];
