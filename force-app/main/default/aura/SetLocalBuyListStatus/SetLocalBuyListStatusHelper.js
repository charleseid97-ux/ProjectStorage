({
	getCurrentGlobalBuyList: function(component) {
        ...
        action.setCallback(this, function(response) {
            if(component.isValid() && response.getState() === "SUCCESS") {
                ...
                component.set("v.globalBuyList", resp);
                this.getLocalBuyList(component);
            }
        });
    ...
    saveLocalBuyList: function(component) {
        ...
        action.setParams( {
            ...
            globalStatus : gloablBuyList.Status__c,
            localStatus : localBuyList.Local_Status__c,
            product : gloablBuyList.Product__c,
            fundSelector : gloablBuyList.Fund_Selector__c,
