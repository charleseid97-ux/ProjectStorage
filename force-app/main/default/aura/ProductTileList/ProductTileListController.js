({
    ...
    setSObjectName: function(component, event, helper) {
        ...
        if(sObjectName == 'Opportunity'){
            var OppRecordId = event.getParam("recordId"); 
            component.set("v.sObjectName", sObjectName);
            component.set("v.OppId", OppRecordId);            
        }
    ...
    confirmSelectedProduct: function(component, event, helper){
        ...
        if(sObjectName === 'Opportunity'){
            ...
            var prodSelectedEvent = $A.get("e.c:ProductSelectorTileSelectedAddToDynamicListOppEvt");
